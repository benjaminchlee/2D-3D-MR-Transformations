...
namespace SSVis
{
    public class NetworkExtrusion : BaseVisualisationExtrusion
    {
        public enum Mode
        {
            All,
        ...
        public Mode ExtrusionMode = Mode.ShortestPathFloydWarshall;
        public bool LiftOnMaxDistance;

        public TextAsset EdgesData;
        public string NodeName = "Station";
        public string OriginName = "StationFrom";
        public string DestinationName = "StationTo";
        public string LinkingName = "Line";
        ...
        {
            // LAZY: Here we blindly assume that the visualisation must only be x and y
            if (dataVisualisation.ZDimension != "Undefined")
            {
                Debug.LogError("NetworkExtrusion: Z Dimension must be undefined!");
                return;
            }

            base.Initialise(dataSource, dataVisualisation, visualisation, extrusionDirection);

            EdgesData = (TextAsset)Resources.Load("TravelTimes");
            SetDataSourceEdges();
            Visualisation.graphDimension = "Blah";
            Visualisation.linkingDimension = "Blah";
        ...
        public override void ExtrudeDimension(float distance, Vector3? extrusionPoint1 = null, Quaternion? extrusionRotation1 = null, Vector3? extrusionPoint2 = null, Quaternion? extrusionRotation2 = null)
        {
            ...
            if (isExtruding && CompareFloats(distance, 0))
            {
                if (isExtruding)
                {
                    isExtruding = false;
            ...
            switch (ExtrusionMode)
            {
                ...
                case Mode.ClosestNode:
                {
                    ...
                    GenerateNodeOffset_Closest(extrusionPoint1.Value, distance);
                    previousExtrusionPoint1 = extrusionPoint1.Value;
                ...
                case Mode.Neighbours:
                {
                    ...
                    GenerateNodeOffset_Neighbours(extrusionPoint1.Value, distance);
                    previousExtrusionPoint1 = extrusionPoint1.Value;
                    positions = extrusionDataPointOffset;
                    break;
                }
                ...
                {
                    if (extrusionPoint1 == null || extrusionPoint2 == null)
                        return;

                    GenerateNodeOffset_ShortestPath(extrusionPoint1.Value, extrusionPoint2.Value, distance);
                    previousExtrusionPoint1 = extrusionPoint1.Value;
                    previousExtrusionPoint2 = extrusionPoint2.Value;
                    positions = extrusionDataPointOffset;
                    break;
                }
                ...
                case Mode.ShortestPathFloydWarshall:
                {
                    ...
                    GenerateNodeOffset_ShortestPathFloydWarshall(extrusionPoint1.Value, extrusionPoint2.Value, distance);
                    previousExtrusionPoint1 = extrusionPoint1.Value;
                    previousExtrusionPoint2 = extrusionPoint2.Value;
                    positions = extrusionDataPointOffset;
                    break;
