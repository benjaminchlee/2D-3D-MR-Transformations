...
namespace Microsoft.MixedReality.SceneUnderstanding.Samples.Unity
{
    ...
    public class SceneUnderstandingManager : MonoBehaviour
    {
        ...
        [Header("Tags")]
        [Tooltip("Tag for Scene Understanding Background objects")]
        public string TagForBackgroundObjects;
        [Tooltip("Tag for the Scene Understanding Wall objects")]
        public string TagForWallObjects;
        [Tooltip("Tag for the Scene Understanding Floor objects")]
        public string TagForFloorObjects;
        [Tooltip("Tag for the Scene Understanding Ceiling objects")]
        public string TagForCeilingObjects;
        [Tooltip("Tag for the Scene Understanding Platform objects")]
        public string TagForPlatformsObjects;
        [Tooltip("Tag for the Scene Understanding Unknown objects")]
        public string TagForUnknownObjects;
        [Tooltip("Tag for the Scene Understanding Inferred objects")]
        public string TagForInferredObjects;
...
#pragma warning restore CS4014
        ...
        private List<GameObject> CreateSUObjectInUnity(SceneUnderstanding.SceneObject suObject)
        {
            ...
            string tag = GetTag(suObject.Kind);
            ...
            if (SceneObjectRequestMode == RenderMode.Quad || SceneObjectRequestMode == RenderMode.QuadWithMask)
            {
                ...
                foreach (SceneUnderstanding.SceneQuad quad in suObject.Quads)
                {
                    ...
                    if (AddColliders)
                    {
                        BoxCollider boxCollider = gameObjectToReturn.AddComponent<BoxCollider>();
                        boxCollider.isTrigger = true;
                        Rigidbody rigidbody = gameObjectToReturn.AddComponent<Rigidbody>();
        ...
        private string GetTag(SceneObjectKind kind)
        {
            string retVal = "";
            ...
            {
                case SceneUnderstanding.SceneObjectKind.Background:
                    retVal = TagForBackgroundObjects;
                    break;
                case SceneUnderstanding.SceneObjectKind.Wall:
                    retVal = TagForWallObjects;
                    break;
                case SceneUnderstanding.SceneObjectKind.Floor:
                    retVal = TagForFloorObjects;
                    break;
                case SceneUnderstanding.SceneObjectKind.Ceiling:
                    retVal = TagForCeilingObjects;
                    break;
                case SceneUnderstanding.SceneObjectKind.Platform:
                    retVal = TagForPlatformsObjects;
                    break;
                case SceneUnderstanding.SceneObjectKind.Unknown:
                    retVal = TagForUnknownObjects;
                    break;
                case SceneUnderstanding.SceneObjectKind.CompletelyInferred:
                    retVal = TagForInferredObjects;
                    break;
                case SceneUnderstanding.SceneObjectKind.World:
                    retVal = TagForWorldObjects;
                    break;
            }

            return (retVal != "") ? retVal : "Untagged";
        }
